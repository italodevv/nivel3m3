...
public class PessoaFisicaDAO {
    ...
    public List<PessoaFisica> getPessoas() {
        ...
        try {
            connection = ConectorBD.getConnection();
            String sql = "SELECT p.idPessoa, p.nome, p.logradouro, p.cidade, p.estado, p.telefone, p.email, pf.cpf FROM dbo.Pessoa p INNER JOIN dbo.PessoaFisica pf ON p.idPessoa = pf.Pessoa_idPessoa";
            statement = connection.prepareStatement(sql);
            resultSet = statement.executeQuery();
    ...
    public int incluir(PessoaFisica pessoa) {
        ...
        try {
            ...
            if (generatedKeys.next()) {
                ...
                String sqlPessoaFisica = "INSERT INTO dbo.PessoaFisica (Pessoa_idPessoa, cpf) VALUES (?, ?)";
    ...
    public void alterar(PessoaFisica pessoa) {
        ...
        try {
            ...
            String sqlPessoaFisica = "UPDATE dbo.PessoaFisica SET cpf = ? WHERE Pessoa_idPessoa = ?";
            statement = connection.prepareStatement(sqlPessoaFisica);
    ...
    public void excluir(PessoaFisica pessoa) {
        ...
        try {
            connection = ConectorBD.getConnection();
            String sqlPessoaFisica = "DELETE FROM dbo.PessoaFisica WHERE Pessoa_idPessoa = ?";
            statement = connection.prepareStatement(sqlPessoaFisica);
